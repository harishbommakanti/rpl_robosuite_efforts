...
class RobotEnv(MujocoEnv):
    ...
    def step(self, action, **kwargs):
        # referencing https://github.com/UT-Austin-RPL/robosuite-soroush/blob/ab3d31aca6f1786398ab850c28249559fb87d1c5/robosuite/environments/robot_env.py#L384

        # use default `step()` from base.py
        obs, reward, done, info = super().step(action)

        # update the info dict with meaningful logging
        info.update(self.get_env_info())

        return obs, reward, done, info
    
    def get_env_info(self):
        # referencing https://github.com/UT-Austin-RPL/robosuite-soroush/blob/ab3d31aca6f1786398ab850c28249559fb87d1c5/robosuite/environments/robot_env.py#L384
        # default, subclasses like lift.py can define their own _get_env_info to add meaningful logging there
