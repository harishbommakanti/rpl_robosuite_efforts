...
class SingleArm(Manipulator):
    ...
    def _load_controller(self):
        ...
        # print("[single_arm.py] self.controller_config[\"type\"]=", self.controller_config["type"])
        # print(f"[single_arm.py] self.controller_config={self.controller_config}")
        self.controller = controller_factory(self.controller_config["type"], self.controller_config)
        # print(f"[single_arm.py] self.controller={self.controller}")
